...
function Todopage() {
  ...
  let formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      try {
        await axios.post(
          "https://todo0-backend-3g9wjyss1-gkavin57.vercel.app/createList",
          values,
          {
            headers: {
  ...
  async function fetchAll() {
    try {
      let listData = await axios.get(
        "https://todo0-backend-3g9wjyss1-gkavin57.vercel.app/getList",
        {
          headers: {
            Authorization: window.localStorage.getItem("myapptoken"),
          },
  ...
  let handleDelete = async (id) => {
    try {
      await axios.delete(
        `https://todo0-backend-3g9wjyss1-gkavin57.vercel.app/deleteList/${id}`,
        {
          headers: {
            Authorization: window.localStorage.getItem("myapptoken"),
          },
